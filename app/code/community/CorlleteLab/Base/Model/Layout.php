 ...
 * @package    CorlleteLab_Boilerplate
 * @copyright  Fabrizio Branca, (http://www.fabrizio-branca.de)
 * @author     Fabrizio Branca, (http://www.fabrizio-branca.de)
 */

class CorlleteLab_Base_Layout extends Mage_Core_Model_Layout {
    ...
    public function generateXml()
    {
        ...
        if (is_array($removeInstructions)) {
            foreach ($removeInstructions as $infoNode) {
                ...
                if (isset($attributes->ifconfig) && ($configPath = (string)$attributes->ifconfig)) {
                    if (!Mage::getStoreConfigFlag($configPath)) {
                        continue;
                    }
                }
